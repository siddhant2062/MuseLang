...
def parse_args():
    ...
    parser.add_argument("--mula_device", type=str2device, default=_default_device, help="Device: cuda, mps, or cpu")
    parser.add_argument("--codec_device", type=str2device, default=_default_device, help="Device: cuda, mps, or cpu")
